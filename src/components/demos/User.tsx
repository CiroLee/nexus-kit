  ...
  return (
    <Card className="p-1.5">
      <div className="relative h-60 overflow-hidden rounded-sm">
        <div className="bg-background/80 hover:bg-background/60 group absolute top-2 right-2 z-3 flex size-8 items-center justify-center rounded-lg backdrop-blur-md backdrop-saturate-200 transition-colors">
          <IconHeartFilled size={14} className="opacity-60 group-hover:opacity-100" />
        </div>
        <ul className="absolute bottom-4 z-3 grid w-full grid-cols-3 justify-items-center gap-2">
          <li className="flex items-end gap-0.5">
            <p className="text-xl leading-4 font-medium">324</p>
            <IconUser size={14} className="text-description" />
          </li>
          <li className="flex items-end gap-1">
            <p className="text-xl leading-4 font-medium">235</p>
            <IconUsers size={14} className="text-description" />
          </li>
          <li className="flex items-end gap-1">
            <p className="text-xl leading-4 font-medium">34</p>
            <IconHeartFilled size={14} className="text-neutral-400" />
          </li>
        </ul>
