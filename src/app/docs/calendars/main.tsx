...
export default function CalendarPage({ sourceCode }: { sourceCode: string[] }) {
    ...
    <div className="flex">
      <div className="main-container @container">
        ...
        <CodeDrawer
          isClient
          codeTabs={[
            { id: 'index', label: 'index.tsx', content: sourceCode[0] },
            { id: 'calendar', label: 'calendar.ts', content: sourceCode[1] },
          ]}
        />
